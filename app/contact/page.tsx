    ...
    try {
      const response = await fetch("http://localhost:3001/api/contact", {
        ...
        body: JSON.stringify({
          ...
          nom: lastName,
          email: email,
          telephone: `${phonePrefix}${phoneNumber}`,
          message: message,
        }),
      });
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  ...
                  <div className="pt-2 flex justify-start">
                    <button
                      ...
                      className="rounded-full bg-[#0d2a4a] hover:bg-[#07192d] text-white px-8 py-3.5 text-xs font-bold shadow-md hover:shadow-lg active:scale-95 transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                    >
